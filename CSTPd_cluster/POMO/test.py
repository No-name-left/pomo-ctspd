...
# ==========================================
MODEL_DIR = './result/20260329_195759_train__ctspd_n20'  # 模型文件夹路径
INSTANCE_FILE = 'C:/Users/lenovo/Desktop/graduation assignment/CTSP-d(用于对照的最优结果)/INSTANCES/Random_small/swiss42-R-3-2-b.ctspd' # 测试文件路径
