...
base.trainer_params['logging']['log_image_params_1']['title_prefix'] = 'CTSPd Cluster Learnable Bias w/o Group Embedding'
base.trainer_params['logging']['log_image_params_2']['title_prefix'] = 'CTSPd Cluster Learnable Bias w/o Group Embedding'
base.logger_params['log_file']['desc'] = 'cluster_n100_d1_learnable_bias_wo_group_embedding'
