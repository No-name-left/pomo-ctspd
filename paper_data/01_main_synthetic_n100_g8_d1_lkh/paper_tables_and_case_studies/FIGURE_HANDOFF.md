...
Project cleanup note: the 2026-04-27 repository cleanup retained this final figure directory as the thesis paper-artifact source. Older external-benchmark and exploratory figure/result folders were moved to local `archive_to_review/` and are no longer recommended as paper-main artifacts.
