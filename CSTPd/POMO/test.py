...
# ==========================================
MODEL_DIR = './result/20260327_193512_train__ctspd_n20'  # 模型文件夹路径
INSTANCE_FILE = 'C:/Users/lenovo/Desktop/graduation assignment/CTSP-d(用于对照的最优结果)/INSTANCES/Random_small/berlin52-R-1-0-a.ctspd' # 测试文件路径
